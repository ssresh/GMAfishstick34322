  ...
  beforeCreate: function beforeCreate() {
    ...
    if (options.i18n) {
      if (options.i18n instanceof VueI18n) {
        ...
        var rootI18n =
          this.$root && this.$root.$i18n && this.$root.$i18n instanceof VueI18n
            ? this.$root.$i18n
            : null; // component local i18n
      ...
      options = Object.keys(props.format).reduce(function (acc, prop) {
        ...
        if (includes(numberFormatKeys, prop)) {
          return Object.assign(
            {},
            acc,
            ((obj = {}), (obj[prop] = props.format[prop]), obj)
          );
        }
...
function update(el, binding, vnode, oldVNode) {
  ...
  if (
    ...
    looseEqual(el._localeMessage, i18n.getLocaleMessage(i18n.locale))
  ) {
    return;
  }
...
var VueI18n = function VueI18n(options) {
  ...
  this._formatFallbackMessages =
    options.formatFallbackMessages === undefined
      ? false
  ...
  this._silentFallbackWarn =
    options.silentFallbackWarn === undefined
      ? false
  ...
  this._componentInstanceCreatedListener =
    options.componentInstanceCreatedListener || null;
  this._preserveDirectiveContent =
    options.preserveDirectiveContent === undefined
      ? false
  ...
  this.getChoiceIndex = function (choice, choicesLength) {
    ...
    if (this$1.locale in this$1.pluralizationRules) {
      return this$1.pluralizationRules[this$1.locale].apply(this$1, [
        choice,
        choicesLength,
      ]);
    } else {
...
VueI18n.prototype.onComponentInstanceCreated =
  function onComponentInstanceCreated(newI18n) {
...
VueI18n.prototype._warnDefault = function _warnDefault(
  ...
  if (this._missing) {
    ...
    if (
      process.env.NODE_ENV !== "production" &&
      !this._isSilentTranslationWarn(key)
    ) {
      warn(
...
VueI18n.prototype._isSilentTranslationWarn = function _isSilentTranslationWarn(
  key
) {
    ...
    if (isPlainObject(message)) {
      ...
      if (!(isString(ret) || isFunction(ret))) {
        if (
          process.env.NODE_ENV !== "production" &&
          !this._isSilentTranslationWarn(key) &&
          !this._isSilentFallback(locale, key)
        ) {
...
VueI18n.prototype._link = function _link(
  ...
  for (var idx in matches) {
    ...
    if (this._isFallbackRoot(translated)) {
      if (
        process.env.NODE_ENV !== "production" &&
        !this._isSilentTranslationWarn(linkPlaceholder)
      ) {
        warn(
...
VueI18n.prototype._createMessageContext = function _createMessageContext(
  values
) {
...
VueI18n.prototype._appendItemToChain = function _appendItemToChain(
  chain,
  item,
  blocks
) {
...
VueI18n.prototype._appendLocaleToChain = function _appendLocaleToChain(
  chain,
  locale,
  blocks
) {
...
VueI18n.prototype._appendBlockToChain = function _appendBlockToChain(
  chain,
  block,
  blocks
) {
...
VueI18n.prototype._getLocaleChain = function _getLocaleChain(
  start,
  fallbackLocale
) {
  if (start === "") {
...
VueI18n.prototype._tc = function _tc(key, _locale, messages, host, choice) {
  ...
  values =
    parsedArgs.locale === null
      ? [parsedArgs.params]
      : [parsedArgs.locale, parsedArgs.params];
  return this.fetchChoice(
...
VueI18n.prototype.mergeLocaleMessage = function mergeLocaleMessage(
  ...
  this._vm.$set(
    ...
    locale,
    merge(
      typeof this._vm.messages[locale] !== "undefined" &&
        Object.keys(this._vm.messages[locale]).length
...
VueI18n.prototype._clearDateTimeFormat = function _clearDateTimeFormat(
  locale,
  format
) {
...
VueI18n.prototype._clearNumberFormat = function _clearNumberFormat(
  locale,
  format
) {
  for (var key in format) {
...
Object.defineProperty(VueI18n, "availabilities", {
  get: function get() {
    if (!availabilities) {
      ...
      availabilities = {
        dateTimeFormat:
          intlDefined && typeof Intl.DateTimeFormat !== "undefined",
